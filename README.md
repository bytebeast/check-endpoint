...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/version-1.0.0-89b4fa?style=social">
  <img alt="Status" src="https://img.shields.io/badge/status-beta-f9e2af?style=social">
  <img alt="License" src="https://img.shields.io/badge/license-MIT-a6e3a1?style=social">
  <img alt="Python" src="https://img.shields.io/badge/python-3.10+-cba6f7?style=social">
</p>
...
| `PROTO`         | HTTP version actually used - `h1` (HTTP/1.1) or `h2` (HTTP/2). Printed last since it is only known after the full response completes. Teal for h2, dim for h1. |
